...
@section('content')
		...
		<div class="container step-1">
			<div class="cach-1 ">
					<p></p>
						<h2>
						Cách 1:<b> Điền thông tin vào bảng dưới đây</b>: <i> Ngay sau khi nhận được đơn đặt hàng (trong giờ làm việc) chúng tôi sẽ chủ động liên hệ với khách hàng sau ít phút. Nếu ngoài giờ làm việc xin phép khách hàng sẽ liên hệ lại trong thời gian làm việc kế tiếp .</i>
							</h2>
						...
						<input name="input_1" id="input_18_1" type="text" value="" class="contact-form-text" placeholder="Họ tên" aria-required="true" aria-invalid="false">
			...
			<div class="cach-4">
				<h2>
				C4. Công ty chúng tôi sẽ rất vinh dự và vui mừng khi bạn đến thăm Công ty tại địa chỉ: 
				</h2>
				<div class="map-responsive">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d551.4963278082238!2d105.8240453692418!3d21.585521796973143!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31352721684ede47%3A0x1e4a34af2b15c066!2zMiBRdWFuZyBUcnVuZywgVGjDoG5oIHBo4buRIFRow6FpIE5ndXnDqm4sIFRow6FpIE5ndXnDqm4sIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1569865893527!5m2!1svi!2s" width="1100" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
			</div>
			</div>
